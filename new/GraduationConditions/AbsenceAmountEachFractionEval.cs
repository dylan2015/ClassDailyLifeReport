...
{
    internal class AbsenceAmountEachFractionEval : IEvaluative
    {
        ...
        public AbsenceAmountEachFractionEval(XmlElement element)
        {
        ...
        Dictionary<string, bool> IEvaluative.Evaluate(IEnumerable<StudentRecord> list)
        {
            ...
            foreach (StudentRecord student in list)
            {
                ...
                foreach (K12.Data.SemesterHistoryItem item in studentHistories[student.ID].SemesterHistoryItems)
                {
